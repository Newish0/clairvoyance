...
// Timestamp: 2025-05-13T23:34:42.996480
...
export interface RealtimeStopTimeUpdate {
  ...
  predicted_arrival_time?: null | string;
  departure_delay?: null | number;
  predicted_departure_time?: null | string;
...
export interface ScheduledTripDocument {
  ...
  scheduled_stop_times?: string[];
  realtime_schedule_relationship?: string;
  realtime_stop_updates?: Record<string, string>;
  current_stop_sequence?: null | number;
  current_status?: null | string;
  vehicle_id?: null | string;
  current_occupancy?: null | string;
  last_realtime_update_timestamp?: null | string;
