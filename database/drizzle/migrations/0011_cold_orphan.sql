...
ALTER TABLE "transit"."stop_time_realtime_instances" ADD COLUMN "stop_id" integer;--> statement-breakpoint
ALTER TABLE "transit"."stop_time_realtime_instances" ADD CONSTRAINT "stop_time_realtime_instances_stop_id_stops_id_fk" FOREIGN KEY ("stop_id") REFERENCES "transit"."stops"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "transit"."stop_time_realtime_instances" DROP COLUMN "timepoint";--> statement-breakpoint
