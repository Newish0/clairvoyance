...
DROP VIEW "transit"."stop_times_static_instances";--> statement-breakpoint
CREATE MATERIALIZED VIEW "transit"."stop_time_static_instances" AS (select "transit"."trip_instances"."id" as "trip_instance_id", "transit"."stop_times"."id" as "stop_time_id", "transit"."stop_times"."stop_sequence", "transit"."stop_times"."timepoint", ("transit"."trip_instances"."start_datetime" + (
            ...
            ))::timestamptz as "scheduled_departure_time", "transit"."stop_times"."stop_headsign", "transit"."stop_times"."pickup_type", "transit"."stop_times"."drop_off_type" from "transit"."trip_instances" inner join "transit"."stop_times" on "transit"."trip_instances"."trip_id" = "transit"."stop_times"."trip_id");--> statement-breakpoint
